...
public class BlogAdapter extends RecyclerView.Adapter<BlogAdapter.HolderData> {
    private List<DataModel> mList;
    private Context ctx;

    public BlogAdapter (Context ctx,List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View layout = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_blog,viewGroup,false);
    ...
    class HolderData extends RecyclerView.ViewHolder{
        ...
        public HolderData(View v){
            ...
            Selengkapnya = (Button)v.findViewById(R.id.btnDetail);
        }
    }
}
