...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.HolderData> {
    private List<DataModel> mList;
    private Context ctx;

    public ProductListAdapter (Context ctx,List<DataModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View layout = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_grid_product,viewGroup,false);
