...
public class ResponseModel {
    String response;
    String id_produk,kode,namaproduk,kategori,harga,deskripsi,foto;
    String id_banner,judul,description,posisi,url,image;
    String id_gallery,tittle,permalink,date,author;
    String id_news,title,category,tag,hits;
    String id_information,metakey,metades,companyname,address,telephone,fax,mobile,email,contactperson,googlemap,youtube,facebook,twitter;
    String id_photogallery,keterangan,berkas,ukuran;
    ...
    public String getId_photogallery() {
        return id_photogallery;
    }

    public void setId_photogallery(String id_photogallery) {
        this.id_photogallery = id_photogallery;
    }
